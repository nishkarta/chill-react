...
export default function Header() {
  ...
  return (
    <header className="header bg-header sticky top-0 z-20 text-light-primary px-5 py-1.5 md:px-10 md:py-3 lg:px-20 lg:py-6">
            ...
            <div onClick={(e)=> e.stopPropagation()} className="profile-dropdown-menu absolute flex flex-col top-full right-0 bg-header py-1 rounded-sm">
              {
                [
                  ...
                  ?.map((each, i) => (
                    <li key={i} className="profile-dropdown-item flex items-center gap-1 whitespace-nowrap px-3 py-2 cursor-pointer hover:text-primary">
